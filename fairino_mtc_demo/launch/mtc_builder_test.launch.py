    ...
    pick_place_demo = Node(
        ...
        arguments=[
            ...
            str(reserved_4).lower(),
                ...
                # "attach_object", "box", tip_frame 
                # "attach_object", "sphere", tip_frame 
                # "attach_object", "cone", tip_frame 
                # "detach_object", "cylinder", tip_frame 
                # "detach_object", "box", tip_frame 
                # "detach_object", "sphere", tip_frame 
                # "detach_object", "cone", tip_frame 
                # "gripper_open"
                # "gripper_close"
                # "joints_move"
                ...
                # "calibrate_camera", "0.2", "6.2", "0.5"

                # "scan_line", "world", "0.5", "0.1", "0.5", "0.25", "0.25", "0.5" # Too fast
                # "trajectory_move", trajectoy_file, "0.1", "0.1", "0.1"
                # "feedback_move", "mode" 
